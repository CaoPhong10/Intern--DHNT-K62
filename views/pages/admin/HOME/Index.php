        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                    ...
                    <a href="../ORDER/Index.php" class="small-box-footer"> Xem chi tiết <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                    ...
                    <a href="../PRODUCT/Index.php" class="small-box-footer"> Xem chi tiết <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-pink">
                    ...
                    <a href="../USERS/Index.php" class="small-box-footer"> Xem chi tiết <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-danger">
                    ...
                    <?php 
                        ...
                        $sql_countbrand = "SELECT COUNT(*) FROM thuonghieu";
                        $kq = mysqli_query($conn, $sql_countbrand);
                        $kq = mysqli_fetch_row($kq);
                        ?>
                        <h3><?php echo $kq[0] ?></h3>
                    ...
                    <a href="../BRAND/Index.php" class="small-box-footer"> Xem chi tiết <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
        </div>
