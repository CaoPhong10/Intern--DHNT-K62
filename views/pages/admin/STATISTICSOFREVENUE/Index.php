...
<div class="pl-4 pt-4 pb">
    ...
    if (isset($_POST["loc"])) {
        ...
        while ($data = mysqli_fetch_assoc($result)) {
            $sheet->setCellValueExplicit('A' . $row, $data['MAHOADON'], \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
            ...
            $sheet->setCellValueExplicit('D' . $row, $data['SOLUONG'], \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_NUMERIC);
