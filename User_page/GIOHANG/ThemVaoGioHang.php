...
if ($slgh != 0) {
    ...
    $dongiaResult = mysqli_query($conn, "SELECT DONGIA, SALE FROM sanpham WHERE MASP = '$masp'");
    ...
    $insertQuery = "INSERT INTO giohang (MASP, SOLUONG, DONGIA, MAND) VALUES ('$masp', $soluong, $dongia, '{$_SESSION['MAND']}')";
