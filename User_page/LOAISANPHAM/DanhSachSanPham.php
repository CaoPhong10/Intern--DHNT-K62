...
if (isset($_GET["filter"])) {
    ...
    WHERE 1=1";
        ...
        if (!empty($hedieuhanh)) {
        $querry .= " AND '$hedieuhanh' LIKE CONCAT('%', thongsokythuat.HEDIEUHANH, '%')";
        }
        ...
        if (!empty($rom)) {
            $querry .= " AND thongsokythuat.ROM = '$rom'";
        }
                ...
                <article class="filter-group">
                    ...
                    <div class="filter-content collapse " id="collapse_5">
                        <div class="inner">
                            ...
                            <label class="checkbox-btn">
                                <input type="checkbox" name="RAM">
                                <span class="btn btn-light"> 6 GB </span>
                            </label>
                    ...
                    <div class="filter-content collapse " id="collapse_6">
                        <div class="inner">
                            <label class="checkbox-btn">
                                ...
                                <span class="btn btn-light"> 32GB </span>
                            </label>

                            <label class="checkbox-btn">
                                <input type="checkbox" name="ROM">
                                <span class="btn btn-light"> 64GB </span>
                            </label>

                            <label class="checkbox-btn">
                                <input type="checkbox" name="ROM">
                                <span class="btn btn-light"> 128GB </span>
                            </label>

                            <label class="checkbox-btn">
                                <input type="checkbox" name="ROM">
                                <span class="btn btn-light"> 256GB </span>
                            </label>
                            <label class="checkbox-btn">
                                <input type="checkbox" name="ROM">
                                <span class="btn btn-light"> 512GB </span>
                            </label>
                        </div> <!-- inner.// -->
                    </div>
                </article>
